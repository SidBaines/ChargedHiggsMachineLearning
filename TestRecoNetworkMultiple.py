...
if 1: # 
    ...
    if (not USE_ENTROPY_TO_ENCOURAGE_SIMPLEATTENTION) and (ATTENTION_OUTPUT_BOTTLENECK_SIZE is None):
        modelfile="/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250510-123629_TrainingOutput/models/Nplits2_ValIdx0/chkpt29_164490.pth" # DSSAR d_model=32,    d_head=8,    n_layers=8,    n_heads=8,    d_mlp=128,
    elif (not USE_ENTROPY_TO_ENCOURAGE_SIMPLEATTENTION) and (ATTENTION_OUTPUT_BOTTLENECK_SIZE is not None):
        # assert(False)
        modelfile="/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250707-132308_TrainingOutput/models/Nplits2_ValIdx0/chkpt29_164490.pth" # DSSAR d_model=32,    d_head=8,    n_layers=8,    n_heads=8,    d_mlp=128,
    elif (USE_ENTROPY_TO_ENCOURAGE_SIMPLEATTENTION) and (ATTENTION_OUTPUT_BOTTLENECK_SIZE is None):
        modelfile="/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250512-093602_TrainingOutput/models/Nplits2_ValIdx0/chkpt29_164490.pth" # DSSAR d_model=32,    d_head=8,    n_layers=8,    n_heads=8,    d_mlp=128,
    elif (USE_ENTROPY_TO_ENCOURAGE_SIMPLEATTENTION) and (ATTENTION_OUTPUT_BOTTLENECK_SIZE is not None):
        modelfile="/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250512-093728_TrainingOutput/models/Nplits2_ValIdx0/chkpt29_164490.pth" # DSSAR d_model=32,    d_head=8,    n_layers=8,    n_heads=8,    d_mlp=128,
...
if 1:
    ...
    scores[(ATTENTION_OUTPUT_BOTTLENECK_SIZE, USE_ENTROPY_TO_ENCOURAGE_SIMPLEATTENTION)] = val_metrics_MCWts.compute_and_log(0, prefix="val_MC", log_level=5, save=False, commit=False, calc_all=True)
