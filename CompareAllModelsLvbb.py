...
model_params = {
    ...
    #     # 'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250501-211920_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt396270.pth',
    #     'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250702-164224_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt_latest.pth', # USED 20250703 - 19:13ish
    #     # 'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250501-211920_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt396270.pth', # EVEN BETTER! 152, 400, 4 blocks, 2 heads per block
    #     'd_attn':None,
    #     'include_mlp':True,
    #     'd_model': 200,
    #     'd_mlp': 400,
    ...
    #     # 'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250629-090811_TrainingOutput/models/qqbb_Nplits2_ValIdx0/chkpt51616.pth',
    #     'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250701-183227_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt_latest.pth',
    #     'd_attn':None,
    #     'include_mlp':True,
    #     'd_model': 200,
    #     'd_mlp': 400,
    ...
    #     'type': 'hl',
    #     # 'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250629-090811_TrainingOutput/models/qqbb_Nplits2_ValIdx0/chkpt51616.pth',
    #     'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250701-183030_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt698050.pth',
    #     'layers':[256,256,256],
    ...
    #     'type': 'hl',
    #     # 'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250629-090811_TrainingOutput/models/qqbb_Nplits2_ValIdx0/chkpt51616.pth',
    #     'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250701-183101_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt698050.pth',
    #     'layers':[256,256,256],
    ...
    #     'type': 'hl',
    #     # 'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250629-090811_TrainingOutput/models/qqbb_Nplits2_ValIdx0/chkpt51616.pth',
    #     'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250701-135852_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt538750.pth',
    #     'layers':[256,256,256],
    #     'PARAMETRISED_NN':False,
    #     'device':'cpu',
    # },
    ...
    #     'type': 'hl',
    #     'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250701-183017_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt540850.pth',
    #     'layers':[256,256,256],
    #     'PARAMETRISED_NN':False,
    #     'device':'cpu',
    # },
    ...
    #     'type': 'hl',
    #     'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250702-072024_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt542000.pth',
    #     'layers':[256,256,256],
    #     'PARAMETRISED_NN':False,
    #     'device':'cpu',
    # },
    ...
    #     'type': 'hl',
    #     'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250702-072034_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt543200.pth',
    #     'layers':[256,256,256],
    #     'PARAMETRISED_NN':False,
    #     'device':'cpu',
    # },
    ...
    #     'type': 'hl',
    #     'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250702-072053_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt543350.pth',
    #     'layers':[256,256,256],
    #     'PARAMETRISED_NN':False,
    #     'device':'cpu',
    # },
    'High-level 1.6-trained' : {
        'type': 'hl',
        'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250702-204720_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt543500.pth',
        'layers':[256,256,256],
        'PARAMETRISED_NN':False,
        'device':'cpu',
    },
    'High-level 1.8-trained' : {
        'type': 'hl',
        'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250702-204737_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt543000.pth',
        'layers':[256,256,256],
        'PARAMETRISED_NN':False,
        'device':'cpu',
    },
    'High-level 2.0-trained' : {
        'type': 'hl',
        'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250702-204909_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt542700.pth',
        'layers':[256,256,256],
        'PARAMETRISED_NN':False,
        'device':'cpu',
    },
    ...
    #     'type': 'hl',
    #     'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250705-184529_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt541900.pth',
    #     'layers':[256,256,256],
    #     'PARAMETRISED_NN':False,
    #     'device':'cpu',
    # },
    ...
    #     'type': 'hl',
    #     # 'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250629-090811_TrainingOutput/models/qqbb_Nplits2_ValIdx0/chkpt51616.pth',
    #     'filepath':'/users/baines/Code/ChargedHiggs_ExperimentalML/output/20250705-184542_TrainingOutput/models/lvbb_Nplits2_ValIdx0/chkpt541000.pth',
    #     'layers':[256,256,256],
    #     'PARAMETRISED_NN':False,
    #     'device':'cpu',
    # },
...
for model_name in model_params:
    ...
    if model_params[model_name]['type']=='Low-level NN (transformer-reco inputs)':
        if 0:
            ...
            sig_rems[model_name] = [vms_MCWts[model_name][f'val_MC_ByMassAcceptance_FixedBkg/sig_lvbb_expected/200_{mass}_mHlow0_mHhigh10000000000.0'] for mass in sorted_masses]
            sig_rems_100[model_name] = [vms_MCWts[model_name][f'val_MC_ByMassAcceptance_FixedBkg/sig_lvbb_expected/100_{mass}_mHlow0_mHhigh10000000000.0'] for mass in sorted_masses]
            roc_aucs[model_name] = [vms_MCWts[model_name][f'val_MC/auc_lvbb_{mass}_mHlow0_mHhigh10000000'] for mass in sorted_masses]
            roc_aucs_central[model_name] = [vms_MCWts[model_name][f'val_MC/auc_lvbb_{mass}_mHlow95_mHhigh140'] for mass in sorted_masses]
            sig_rems_central[model_name] = [vms_MCWts[model_name][f'val_MC_ByMassAcceptance_FixedBkg/sig_lvbb_expected/200_{mass}_mHlow95000.0_mHhigh140000.0'] for mass in sorted_masses]
            sig_rems_100_central[model_name] = [vms_MCWts[model_name][f'val_MC_ByMassAcceptance_FixedBkg/sig_lvbb_expected/100_{mass}_mHlow95000.0_mHhigh140000.0'] for mass in sorted_masses]
        else:
            ############   DATA PREP CONFIG  ################
        ...
        model = ConfigurableNN(
                ...
                hidden_layers=model_params[model_name]['layers'],
                dropout_prob=0.0,
                use_batchnorm=False
                ).to(device)
        model.load_state_dict(torch.load(model_params[model_name]['filepath'], map_location=device))
        ...
        roc_aucs_central[model_name] = [vms_MCWts[model_name][f'val_MC/auc_lvbb_{mass}_mHlow95_mHhigh140'] for mass in sorted_masses]
        sig_rems_central[model_name] = [vms_MCWts[model_name][f'val_MC_ByMassAcceptance_FixedBkg/sig_lvbb_expected/200_{mass}_mHlow95000.0_mHhigh140000.0'] for mass in sorted_masses]
        sig_rems_100_central[model_name] = [vms_MCWts[model_name][f'val_MC_ByMassAcceptance_FixedBkg/sig_lvbb_expected/100_{mass}_mHlow0_mHhigh10000000000.0'] for mass in sorted_masses]
...
if 0:
    ...
    import pickle
    with open('sig_rems_lvbb.pkl', 'wb') as f:
        pickle.dump(sig_rems, f)
    with open('roc_aucs_lvbb.pkl', 'wb') as f:
        pickle.dump(roc_aucs, f)
    with open('sig_rems_central_lvbb.pkl', 'wb') as f:
        pickle.dump(sig_rems_central, f)
    with open('sig_rems_100_lvbb.pkl', 'wb') as f:
        pickle.dump(sig_rems_100, f)
    with open('sig_rems_100_central_lvbb.pkl', 'wb') as f:
        pickle.dump(sig_rems_100_central, f)
    with open('roc_aucs_central_lvbb.pkl', 'wb') as f:
        pickle.dump(roc_aucs_central, f)
    with open('tot_wts_per_dsid_lvbb.pkl', 'wb') as f:
        pickle.dump(tot_wts_per_dsid, f)
# %%
if 0:
    # Load the calculated data
    import pickle
    with open('sig_rems_lvbb.pkl', 'rb') as f:
        sig_rems = pickle.load(f)
    with open('roc_aucs_lvbb.pkl', 'rb') as f:
        roc_aucs = pickle.load(f)
    with open('sig_rems_central_lvbb.pkl', 'rb') as f:
        sig_rems_central = pickle.load(f)
    with open('sig_rems_100_lvbb.pkl', 'rb') as f:
        sig_rems_100 = pickle.load(f)
    with open('sig_rems_100_central_lvbb.pkl', 'rb') as f:
        sig_rems_100_central = pickle.load(f)
    with open('roc_aucs_central_lvbb.pkl', 'rb') as f:
        roc_aucs_central = pickle.load(f)
    with open('tot_wts_per_dsid_lvbb.pkl', 'rb') as f:
        tot_wts_per_dsid = pickle.load(f)

# %%
for model_name in sig_rems:
    print(f"{model_name}:", end=' ')
    for k in range(len(sig_rems[model_name])):
        print(f"{sorted_masses[k]}: {sig_rems[model_name][k]:8.2f}", end=', ')
    print()
for model_name in roc_aucs:
    print(f"{model_name}:", end=' ')
    for k in range(len(roc_aucs[model_name])):
...
plotSaveDir = 'NNPerformancePlotsForThesisLvbb/jNNpNNiNN'
# plotSaveDir = 'NNPerformancePlotsForThesisLvbb/jNNpNNlowLevelTransformerReco'
# plotSaveDir = 'NNPerformancePlotsForThesisLvbb/jNNpNNlowLevel'
